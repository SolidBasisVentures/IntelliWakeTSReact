...
var Button = React.forwardRef(function (props, ref) {
    var _a, _b, _c, _d, _e;
    var TagToUse = ((_a = props.tag) !== null && _a !== void 0 ? _a : !!props.to) ? 'a' : 'button';
    return (React__default['default'].createElement(TagToUse, { className: (_b = props.classNameOverride) !== null && _b !== void 0 ? _b : ((_c = props.className) !== null && _c !== void 0 ? _c : '') +
        ...
        , type: (_e = props.type) !== null && _e !== void 0 ? _e : 'button', onClick: props.onClick, tabIndex: props.tabIndex, ref: ref, href: props.to, onKeyDown: props.onKeyDown, onKeyPress: props.onKeyPress, autoFocus: props.autoFocus, hidden: props.hidden, disabled: props.disabled, style: props.style, title: props.title, children: props.children }));
});
